...
export default function MoviePage() {
  ...
  const cards = filterLists.length == 0 ?(
    ...
    return (
      <>
    <div className="flex items-center justify-between p-2 border-2 rounded-full mt-2 border-slate-950 w-1/2 m-auto">
  ...
  <div className=" bg-white grid grid-cols-5 gap-4 mt-2 px-16 py-32 capitalize">
    {cards}
  </div>
  </>
  )
