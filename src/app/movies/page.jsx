...
export default function MoviePage() {
  ...
  const cards = filterLists.length == 0 ?(
    ...
    return (
      <>
    <div className="flex items-center bg-white justify-between p-2 border-2 w-4/12 rounded-full mt-2 border-blue-950 m-auto">
  ...
  <div className="h-auto bg-gray-800 grid grid-cols-5 gap-4 mt-2 px-16 py-32 capitalize">
    {cards}
  </div>
  </>
  )
