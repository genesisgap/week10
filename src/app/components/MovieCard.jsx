...
export default function MovieCard({ title, type, rate, run, release, gen, kind }) {
  return (
    <div className="flex flex-col items-center h-auto bg-gray-900 gap-0 mx-auto justify-items-start px-2 py-2 rounded-md shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out w-full">
      ...
      <div className="text-left mt-4">
        ...
        <h1 className="text-lg font-semibold text-gray-500 hover:text-blue-700 mt-4">{title}</h1>
